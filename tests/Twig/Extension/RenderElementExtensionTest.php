...
EOT
    ...
    public function getRenderViewElementCompareTests(): iterable
    {
        return [
            ...
            ['<th>Data</th> <td>SonataAdmin<br/>Example</td><td>SonataAdmin<br/>Example</td>', 'virtual_field', 'Example', ['template' => 'custom_show_field.html.twig', 'safe' => false, 'SonataAdmin'], null],
